    ...
    <div className="bg-background">
      <div className="container mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8">
        <div className="text-center">
          <h2 className="font-headline text-base font-semibold uppercase tracking-wider text-primary">Our Legacy</h2>
          ...
          <p className="mt-5 max-w-prose mx-auto text-xl text-muted-foreground">
            A journey into the heart of fragrance, where India's rich heritage meets contemporary elegance.
          </p>
        </div>
        ...
        <div className="mt-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              <h3 className="text-3xl font-headline font-extrabold tracking-tight border-b-2 border-primary pb-2">Our Philosophy</h3>
            ...
            <div className="relative h-96 w-full rounded-lg overflow-hidden shadow-xl">
               <Image
                ...
                alt="Artisan perfumery workshop with Mughal influences"
                layout="fill"
                objectFit="cover"
         ...
         <div className="mt-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
             <div className="relative h-96 w-full rounded-lg overflow-hidden shadow-xl md:order-2">
               <Image
                src="https://placehold.co/800x600.png"
                alt="Rare botanical perfume ingredients on a decorative tray"
                layout="fill"
                objectFit="cover"
            ...
            <div className="md:order-1">
              <h3 className="text-3xl font-headline font-extrabold tracking-tight border-b-2 border-primary pb-2">Our Mission</h3>
              <p className="mt-6 text-lg text-muted-foreground">
